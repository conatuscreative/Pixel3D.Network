...
{
    static class DisconnectStrings
    {
        // Sent by server:
        ...
        // Sent by client:
        public const string BecomingHost = "Becoming host"; // sent to peers who were not app-connected and connected at host migration time
