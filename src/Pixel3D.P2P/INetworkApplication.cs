...
namespace Pixel3D.P2P
{
    ...
    public interface INetworkApplication
    {
        ...
        /// <param name="joinMessage">The connection message that you can append user data to, to be received by <see cref="JoinOnClient"/>.</param>
        /// <param name="connectedMessage">The connection message that you can append user data to, to be received by <see cref="ConnectedOnClient"/>.</param>
        ...
        /// <param name="message">The disconnection message that you can append user data to, to be received by <see cref="LeaveOnClient"/>.</param>
        ...
        /// <remarks>On error, throw <see cref="NetworkDataException"/> or a derived exception (usually <see cref="ProtocolError"/>)</remarks>
        ...
        /// <summary>Called when the server has changed due to host migration. The P2PNetwork.RemotePeers collection has changed, and connection IDs may be repeated.</summary>
