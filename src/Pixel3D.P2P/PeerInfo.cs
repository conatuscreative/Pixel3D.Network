...
namespace Pixel3D.P2P
{
    public class PeerInfo
    {
        ...
        public UInt64 SideChannelId { get; internal set; }
        ...
        internal PeerInfo() { } // <- construct manually

        internal PeerInfo(NetIncomingMessage message, bool useExistingPlayerData = false, byte[] existingPlayerData = null)
        {
            ...
            if(useExistingPlayerData)
                this.PlayerData = existingPlayerData; // NOTE: can be null
            else
                this.PlayerData = message.ReadByteArray();
        }
